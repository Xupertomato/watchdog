    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('ADMIN', 'Admin'), ('MANAGER', '管理員'), ('ELDER', '長者')], default='ADMIN', max_length=50, verbose_name='Type')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('uploadedFile', models.FileField(blank=True, null=True, upload_to=home.models.media_upload_path)),
                ('taggedElder', models.ManyToManyField(related_name='tagged_elder', to=settings.AUTH_USER_MODEL)),
                ('uploader', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='records_uploader', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Elder',
